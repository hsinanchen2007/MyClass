...
https://www.educative.io/module/lesson/cpp-standard-library/3j2WRGJRql9
...
The algorithms need random access iterators. RanNumGen&& gen has to be callable, taking an argument and returning a 
value within its arguments. URNG&& gen has to be a uniform random number generator.

? Prefer std::shuffle
Use std::shuffle instead of std::random_shuffle. std::random_shuffle has been deprecated since C++14 and removed in 
C++17, because it uses the C function rand internally.
