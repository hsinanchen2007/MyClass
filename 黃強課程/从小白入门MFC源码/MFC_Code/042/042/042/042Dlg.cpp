...
BOOL CMy042Dlg::OnInitDialog()
{
	...
	HTREEITEM hRoot=m_tree.InsertItem(L"根节点",0,0);
	HTREEITEM hMusic = m_tree.InsertItem(L"音乐",0,0,hRoot);
	m_tree.InsertItem(L"啤酒",1,1, hRoot);
	m_tree.InsertItem(L"炸鸡", 2,2,hRoot);
	
	m_tree.InsertItem(L"欢乐颂",1,1, hMusic);
