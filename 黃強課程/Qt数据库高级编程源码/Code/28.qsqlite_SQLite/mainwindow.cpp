    ...
    , ui(new Ui::MainWindow)
{
   ...
   //水平方向拉升
    ...
    setWindowTitle("Qt  QSQLITE驱动访问SQLite");
}
...
void MainWindow::on_pushButtonConn_clicked()
{
    ...
    //设置连接参数
    QString  strDBPath = QApplication::applicationDirPath()+"/school.db";
    db.setDatabaseName(strDBPath );//数据库的文件路径
...
void MainWindow::on_pushButtonInsert_clicked()
{
    ...
    QString  sql=QString("INSERT INTO Student VALUES(NULL, '%1',%2,%3 )")
   ...
   if(ret)
   {
       ...
       //获取刚刚插入成功的自增id
        QString sql2= "SELECT   last_insert_rowid()";
...
void MainWindow::on_pushButtonInsert_clicked()
{
    ...
    //准备一条SQL语句，使用？当做占位符
    query.prepare("INSERT INTO Student VALUES( NULL,?,?,?)");
    //为占位符赋值
...
void MainWindow::on_pushButtonInsert_clicked()
{
    ...
    query.prepare("INSERT INTO Student VALUES( NULL,:name,:age,:score)");
    //为占位符赋值
...
void MainWindow::on_pushButtonUpdate_clicked()
{
    ...
    QString  sql=QString("UPDATE  Student SET name='%1', "
            ...
            .arg("名称被修改").arg(66).arg(77.77).arg(2);
