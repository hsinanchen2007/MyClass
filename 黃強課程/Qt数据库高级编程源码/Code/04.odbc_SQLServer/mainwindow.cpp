    ...
    , ui(new Ui::MainWindow)
{
   ...
   //水平方向拉升
    ...
    setWindowTitle("Qt ODBC访问SQL Server");
}
...
void MainWindow::on_pushButtonConn_clicked()
{
    ...
    //设置连接参数
    db.setDatabaseName("hq");//参数是DSN的名称
    db.setUserName("sa"); //连接数据库的用户名
    db.setPassword("sa123");//连接数据库的密码
...
void MainWindow::on_pushButtonConn2_clicked()
{
    ...
    db.setDatabaseName(
                ...
                QString("DRIVER={%1};"
                              ...
                              // .arg("SQL SERVER")//不区分大小写
                               //.arg("sql server native client 11.0")
                              .arg("odbc driver 17 for sql server")
                               .arg("192.168.16.105")
                               .arg("School")
                               .arg("sa")
                               .arg("sa123")
...
void MainWindow::on_pushButtonInsert_clicked()
{
    ...
    query.prepare("INSERT INTO Student VALUES( :name,:age,:score)");
    //为占位符赋值
    ...
    //获取数据库连接的对象
     ...
     if(ret)
     {
         ...
         while( query.next())
         {
                ...
                float  score = query.value(3).toFloat();
